...
export const agents: AgentInfo[] = [
  {
    id: "conductor",
    name: "The Conductor",
    character: "Commute Agent",
    role: "Commute analysis",
    color: "#5B8C5A",
    emoji: "🚂",
    processingMessage: "Wait, the iron horse approaches!",
    completedMessage: "Computed the whistle-stop trek!",
  },
  {
    id: "steward",
    name: "Lin",
    character: "Budget Fit Agent",
    role: "Cost analysis",
    color: "#C2705B",
    emoji: "🌟",
    processingMessage: "Looking at your coin purse...",
    completedMessage: "It's a tight squeeze, but we made it work.",
  },
  {
    id: "baron",
    name: "The Baron",
    character: "Market Fairness Agent",
    role: "Fairness check",
    color: "#D4A957",
    emoji: "🎩",
    processingMessage: "Consulting the Great Ledger of Zillow...",
    completedMessage: "I have determined the true value.",
  },
  {
    id: "kiki",
    name: "Kiki",
    character: "Neighborhood Agent",
    role: "Local scout",
    color: "#8B5CF6",
    emoji: "🧹",
    processingMessage: "Doing a fly-over of the block!",
    completedMessage: "Mapped the local pulse for you!",
  },
  {
    id: "spider",
    name: "Soot Sprite",
    character: "Hidden Cost Agent",
    role: "Fine print",
    color: "#3B3028",
    emoji: "🕷️",
    processingMessage: "Crawling through the fine print...",
    completedMessage: "Nothing escapes my eyes.",
  },
  {
    id: "kamaji",
    name: "Kamaji",
    character: "Final Synthesis",
    role: "Aggregator",
    color: "#1F2937",
    emoji: "♨️",
    processingMessage: "Pulling all the threads together...",
    completedMessage: "Take this map—it's everything you need.",
  },
];
